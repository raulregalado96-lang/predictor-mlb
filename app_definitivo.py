...
st.markdown("El sistema detecta la fecha actual y sincroniza los datos al iniciar.")

@st.cache_data(ttl=86400) # Se actualiza automáticamente cada 24 horas
def obtener_datos_completos(anio):
    # Creamos un contenedor de barra de progreso
...
# Llamada a los datos con la barra de progreso
with st.container():
